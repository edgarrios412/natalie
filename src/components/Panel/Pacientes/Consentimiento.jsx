...
const Consentimiento = ({ fn, paciente, id }) => {
    ...
    return (
        <>
            ...
            {id == 1 && <p className={style.consen}><h3>INDICACIONES DE CUIDADOS PRE y POST-OPERATORIOS PARA PACIENTES ORTODONTICOS CON MINI IMPLANTES</h3>
            ...
            {id == 2 && <p className={style.consen}><h3>CONSENTIMIENTO INFORMADO DE ENDODONCIA</h3>

                Ciudad: <input value={paciente.ciudad} disabled type="text" className={style.inputCon} /> fecha : <input type="text" className={style.inputCon} /> Yo: <input value={paciente.name} disabled type="text" className={style.inputCon} /> identificado con CC <input value={paciente.cedula} disabled type="text" className={style.inputCon} />
                actuando en nombre propio o como representante legal del menor de edad o persona con incapacidad mental para tomar
                decisiones cuyo nombre es: <input type="text" className={style.inputCon} /> con documento de identidad No. <input type="text" className={style.inputCon} />
            ...
            {id == 3 && <p className={style.consen}><h3>CONSENTIMIENTO INFORMADO PARA PACIENTES ORTODONTICOS CON MINI-IMPLANTES</h3>

                NOMBRE Y APELLIDO DEL PROFESIONAL:<input type="text" value={`${user?.name} ${user?.lastname}`} disabled className={style.inputCon} />

                CONSULTORIO":<input type="text" className={style.inputCon} />
                ...
                Fecha: <input type="text" className={style.inputCon} />
                Firma del paciente o responsable:<input type="text" className={style.inputCon} />
            </p>}
            {id == 4 && <p className={style.consen}><h3>CONSENTIMIENTO INFORMADO DE OPERATORIA DENTAL</h3>
            ...
            {id == 5 && <p className={style.consen}>
                ...
                {paciente.edad > 17 ? <p>El Sr(a)<input type="text" disabled value={paciente.name} className={style.inputCon} />  de <input type="text" value={paciente.edad} disabled className={style.inputCon} />años de edad,
                    ...
                    <p>El Sr(a) <input type="text" disabled className={style.inputCon} /> de <input type="text" disabled className={style.inputCon} /> años de edad,  con cedula
                        ...
                        acudiente de el Sr(a) <input type="text" className={style.inputCon} />.</p>}


                DECLARO

                Que el/la Dr.(a) <input type="text" value={`${user?.name} ${user?.lastname}`} disabled className={style.inputCon} /> me ha
            ...
            {id == 6 && <p className={style.consen}><h3>CONSENTIMIENTO INFORMADO PARA URGENCIAS ODONTOLOGICAS</h3>
